...
const displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGame} games. Currently, ${unfundedGamesCount} game${unfundedGamesCount === 1 ? ' remains' : 's remain'} unfunded. We need your help to fund these amazing games!`;
